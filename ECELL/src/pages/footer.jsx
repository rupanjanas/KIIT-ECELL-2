...
function Footer() {
  ...
  <div className="flex w-full max-w-xs relative items-center">
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-gray-700 flex flex-col sm:flex-row items-center justify-between">
        ...
        <div className="flex space-x-4">
          ...
          {/* LinkedIn */}
          <a href="#" className="flex items-center justify-center w-8 h-8 ">
          ...
          {/* Instagram */}
          <a href="#" className="flex items-center justify-center w-8 h-8 rounded-md border border-blue-600 bg-gray-700 hover:bg-blue-600 transition-colors duration-200">
